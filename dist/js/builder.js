...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * @returns {Object}
	 */
	function updateObject(object, source) {
	...
	function getPage(name, params) {
	    var page = __webpack_require__(9)("./" + name + '/build').default;
	    if (params) {
	        return page(params);
	    } else {
	        return page();
	 ...
	 * @returns {any}
	 */
	function getLayout(name, params) {
	    var layout = __webpack_require__(6)("./" + name + '/build').default;
	    if (params) {
	...
	function getModule(name, params) {
	    var module = __webpack_require__(7)("./" + name + '/build').default;
	    if (params) {
	...
	function getComponent(name, params) {
	    var component = !(function webpackMissingModule() { var e = new Error("Cannot find module \"../../modules/_components\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()).default;
	    if (params) {
	 ...
	 * @returns {any}
	 */
	function wrapTemplate(template, params) {
	    if (params) {
	        return function (externalParams) {
	            if (externalParams) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = templates.wrapTemplate(template, params);
...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"logo":"logo-1p0hr__logo","logo--black":"logo-1Ww8f__logo--black"};

/***/ },
/* 18 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "./img/img-d169.jpg";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h1 class=\""
	    + ((stack1 = container.lambda(((stack1 = (depth0 != null ? depth0.styles : depth0)) != null ? stack1.logo : stack1), depth0)) != null ? stack1 : "")
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n    <title>lolitaframework</title>\n    <meta charset=\"UTF-8\">\n    <meta name=\"viewport\" content=\"width=device-width, initial-scale=1\"/>\n    <meta name=\"format-detection\" content=\"telephone=no\">\n</head>\n<body>\n"
	    + ((stack1 = ((helper = (helper = helpers.header || (depth0 != null ? depth0.header : depth0)) != null ? helper : helpers.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},{"name":"header","hash":{},"data":data}) : helper))) != null ? stack1 : "")
